...
Salida: Retorna una variable de tipo Lista que va insertando los datos desde el final.

Proceso: La funcion revise una variable de tipo de Lista de nombre L ademas de los parametros de tPersonas.
         Luego la variable pPersonas va creando nodos llamando a la funcion creaNodo.
...
Salida: Retorna una variable de tipo Lista con el total de entradas que existen por cada rut.
Proceso: La funcion crea 4 variables de tipo lista y 2 variables de tipo entero, luego al puntero aux se le da el valor de la lista ingresada L y al puntero nuevalista se le asigna el valor NULL.
...
Proceso: La funcion crea dos variables de tipo Lista y se definen dos enteros para saber las cantidad de entradas totales que se asignaron, luego con un while
         ...
         Luego con un if revisamos si la cantidad de entradas por rut es igual o menor a 5 si es asi, se cumplira que:
         ...
         de entradas es 50, luego si esto no se cumple se revisara si la cantidad de entradas es mayor a 2, si es asi al usuario solo se le entregaran 2 entradas y luego
         si tampoco se cumple esta condicion se le entragarn las entradas solcitadas por el usuario, luego la variable auxiliar pasara al siguiente nodo hasta que auxiliar
